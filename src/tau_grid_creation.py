...
if __name__ == "__main__":
    ...
    qx_grid, qy_grid, tau_grid = parallel_tau_matrix_grid(n_points=64, E=2*(square_lattice.omega_e + collective_lamb_shift), n_jobs=6, lattice=square_lattice, sigma_func_period=sigma_func_period_numba)
